...
const COMMON_PREMIUM_FEATURES = [
  ...
  'Синхронизация прогресса на всех устройствах',
        ...
        {isSuccess ? (
          <div className="py-10 flex flex-col items-center justify-center text-center animate-in zoom-in-95 duration-300">
            ...
            <p className="text-slate-300 text-xs sm:text-sm max-w-md mb-5">
              Подписка на {selectedPlan.title} успешно активирована. Теперь вам доступны максимальное качество, скачивание серий и все возможности Premium.
            </p>
          ...
          <div className="space-y-5">
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-slate-400 mt-1 max-w-md mx-auto">
                Максимальное качество Full HD, прямое скачивание серий, чтение манги и эксклюзивные функции
              </p>
            </div>
